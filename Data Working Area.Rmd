...
Regular Season Team Comparision table
```{r}
...
teamplayoffadvfin <- subset(teamplayoffadv,select=-c(playoff_rk,playoff_player,playoff_age,playoff_tm,playoff_pos,playoff_gp))

#merge teamplayoffs
# playofftotal <- 

left_join(teamplayoff,teamplayadvfin)
